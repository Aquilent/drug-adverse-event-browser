...
class VerifyTextSearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_verify_text_search(self):
        driver = self.driver
        driver.get(self.base_url + "/")
        driver.find_element_by_id("drug").clear()
        driver.find_element_by_id("drug").send_keys("Motrin")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        # ERROR: Caught exception [ERROR: Unsupported command [getTable | //table.1.0 | ]]
        driver.find_element_by_id("drug").clear()
        driver.find_element_by_id("drug").send_keys("Tylenol")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        # ERROR: Caught exception [ERROR: Unsupported command [getTable | //table.1.0 | ]]
        driver.find_element_by_id("drug").clear()
        driver.find_element_by_id("drug").send_keys("Codeine")
        driver.find_element_by_xpath("//button[@type='submit']").click()
