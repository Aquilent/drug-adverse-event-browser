...
* **Development** — developed front-end and back-end code, using a fully open source toolset including  Linux, Docker, Apache HTTP, PHP, Laravel Framework, Python, Twitter Bootstrap, and many others **(Play 8)**.  We created documentation to [install and run the prototype](doc/05_Development/RunningThePrototypeLocally.md) on another machine
